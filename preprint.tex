...
\noindent {\LARGE \textbf{\textsf{SVD entropy reveals the high
complexity of ecological networks}}}
...
Montréal; \textsuperscript{2}\,Québec Centre for Biodiversity
Sciences; \textsuperscript{3}\,School of Mathematics and Statistics,
...
\textbf{Abstract}:\,Quantifying the complexity of ecological networks
has remained elusive. Primarily, complexity has been defined on the
basis of the structural (or behavioural) complexity of the system. These
definitions ignore the notion of `physical complexity,' which can
